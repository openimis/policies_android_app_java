...
<<<<<<< HEAD:app/src/main/java/cm/ynote/educash/ToRestApi.java
        final String[] content = {null};
        HttpClient httpClient = new DefaultHttpClient();
        HttpGet httpGet = new HttpGet(uri+functionName);
        httpGet.setHeader("Content-type", "application/json");

        Log.d("Rest API Function Name",functionName);
        Log.d("Rest API URL",uri);
...
>>>>>>> repo/main:app/src/main/java/org/openimis/imispolicies/ToRestApi.java
    }
