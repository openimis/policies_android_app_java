                ...
                CreateFamilyMutationInput.builder()
                        ...
                        .headInsuree(
                                FamilyHeadInsureeInputType.builder()
                                        ...
                                        .mutualInsuranceCoverage(head.getMutualInsuranceCoverage())
                                        .housingType(head.getHousingType())
                                        .noDisability(head.getNoDisability())
                                        .nonDisablingDisease(head.getNonDisablingDisease())
