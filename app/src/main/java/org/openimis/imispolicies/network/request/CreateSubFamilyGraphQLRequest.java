                ...
                CreateFamilyMutationInput.builder()
                        ...
                        .headInsuree(
                                FamilyHeadInsureeInputType.builder()
                                        ...
                                        .residenceEnvironment(head.getResidenceEnvironment())
                                        .mutualInsuranceCoverage(head.getMutualInsuranceCoverage() != null && head.getMutualInsuranceCoverage() != 0 ? head.getMutualInsuranceCoverage() : null)
                                        .housingType(head.getHousingType() != null && !head.getHousingType().equals("0") && !head.getHousingType().isEmpty() ? Integer.parseInt(head.getHousingType()) : null)
                                        .noDisability(head.getNoDisability() != null && head.getNoDisability() != 0 ? head.getNoDisability() : null)
                                        .nonDisablingDisease(head.getNonDisablingDisease() != null && !head.getNonDisablingDisease().equals("0") && !head.getNonDisablingDisease().isEmpty() ? Integer.parseInt(head.getNonDisablingDisease()) : null)
