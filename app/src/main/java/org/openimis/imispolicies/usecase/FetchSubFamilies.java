...
public class FetchSubFamilies {
    ...
    private Family.Member toMember(@NonNull GetSubFamiliesQuery.Edge1 edge, @NonNull GetSubFamiliesQuery.Node family) {
        ...
        return new Family.Member(
                ...
                /* incomeLevel = */ member.incomeLevel() != null && member.incomeLevel().id() != null ? IdUtils.getIdFromGraphQLString(Objects.requireNonNull(member.incomeLevel()).id()) : null,
               /* residenceEnvironment = */ member.residenceEnvironment() != null && member.residenceEnvironment().id() != null ? IdUtils.getIdFromGraphQLString(Objects.requireNonNull(member.residenceEnvironment()).id()) : null,
                ...
                /* noDisability = */ member.noDisability() != null && member.noDisability().id() != null ? IdUtils.getIdFromGraphQLString(Objects.requireNonNull(member.noDisability()).id().toString()) == 1 : null,
                /* nonDisablingDisease = */ member.nonDisablingDisease() != null && member.nonDisablingDisease().id() != null ? String.valueOf(IdUtils.getIdFromGraphQLString(Objects.requireNonNull(member.nonDisablingDisease()).id().toString())) : null,
                /* mutualInsuranceCoverage = */ member.mutualInsuranceCoverage() != null && member.mutualInsuranceCoverage().id() != null ? IdUtils.getIdFromGraphQLString(Objects.requireNonNull(member.mutualInsuranceCoverage()).id().toString()) == 1 : null,
                /* housingType = */ member.housingType() != null && member.housingType().id() != null ? String.valueOf(IdUtils.getIdFromGraphQLString(Objects.requireNonNull(member.housingType()).id().toString())) : null,
